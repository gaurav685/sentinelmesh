...
TOPICS: dict[str, TopicSpec] = {
    ...
    for t in (
        ...
        _spec("graph.commands", 12, "tenant+entity", "7d", "delete",
              ("stream-processor", "detection-engine"), ("graph-writer",)),
        ...
        _spec("detections", 12, "tenant", "90d", "delete",
              ("detection-engine",),
              ("api-projection", "ai-analyst", "agent-orchestrator", "memory", "reporting",
               "notification-fanout")),
        _spec("attack_chains", 6, "tenant", "180d", "delete",
              ("stream-processor", "detection-engine"),
              ("graph-writer", "ai-analyst", "memory", "reporting")),
