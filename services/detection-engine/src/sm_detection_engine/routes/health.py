...
`/readyz` probes PostgreSQL, the Kafka producer and the Kafka consumer — all
required. `ml-inference` is **not** probed here: it is an optional contribution
and its absence degrades a score rather than stopping the service (ADR-013).
"""
