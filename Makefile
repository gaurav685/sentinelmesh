...
setup:
	$(PY) -m pip install -e "packages/contracts-py[dev]" -e "packages/common-py[dev]" -e "services/api-gateway[dev]" -e "services/ingestion-gateway[dev]" -e "services/normalization-engine[dev]" -e "services/stream-processor[dev]"
